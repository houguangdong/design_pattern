...
class CreamyBaconBuilder:
    ...
    def add_topping(self):
        print 'adding the topping (mozzarella, bacon, ham, mushrooms, red_onion, oregano) to your creamy bacon'
        ...
        time.sleep(STEP_DELAY)
        print 'done with the topping (mozzarella, bacon, ham, mushrooms, red_onion, oregano) to your creamy bacon)'
...
#     main()
    builder = PizzaBuilder1().add_garlic().add_extra_cheese().build()
